...
class THUMOSdetection(object):
    ...
    def __init__(self, ground_truth_filename=None, prediction_filename=None,
                 ...
                 verbose=False, ontal_gt_from_cls_anno=None):
        ...
        if ontal_gt_from_cls_anno is None:
            self.ground_truth = self.load_gt_seg_from_json(
                ground_truth_filename)
        else:
            print('load annotation from oad: ', ontal_gt_from_cls_anno)
            self.ground_truth = mmcv.load(ontal_gt_from_cls_anno)
